...
- 2026-07-27 — docs: rename docs/reconciliation.md to docs/conflicts.md to end the name collision with the check-in reconciliation.md files; all referrers retargeted.
