...
- **Day 3 (2026-06-24 → 2026-06-25):** **Hardening/integration — the archive-recovery
  ...
  never laundered by a backup) and **H296** (the same alarm travels in the `--with-archive`
  bundle, the bundle-path twin) both **shipped 2026-06-23** — the alarm is now proved
  un-launderable across *both* transports — leaving **H297** (the JSONL-backup recovery
  dogfood, the H292 twin on the backup path) as the last hardening slot. Close a de-prioritized
  guard (H244–H249) only if none of these is ready, and prefer closing one over appending more
