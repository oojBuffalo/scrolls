...
new guard catches that the scattered per-tier tests miss. Test-only, no production change. **H367–H368
+ the H374 import-axis cell remain un-started.**
...
repair-convergence guard, the third pivot cell), and **H366 shipped this run** (the
`context --budget` tier-nesting contract guard, the fourth pivot cell); H367–H368 + the H374
...
— take the next one whose preconditions are met (H367 next):
