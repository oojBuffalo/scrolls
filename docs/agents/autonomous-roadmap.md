...
partition). Take **H285 next** (`archive show --all`, the full archived-history read) —
**H284 shipped 2026-06-22, closing the archive-recovery sub-theme (H280–H284)**: the
