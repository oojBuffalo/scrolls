...
Field Theory CLI and `mvanhorn/last30days-skill`:
...
These are good for a personal-knowledge/productivity app but conflict with
`docs/vision.md` ("this is a library, not a note app") and custody-vision
("retrieval of what you hold, not discovery"):
