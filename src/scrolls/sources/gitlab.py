...
def fetch_item(
    ...
    *,
    ...
    """Fetch a detected GitLab project's metadata and README; return it at stage 'fetched'.

    Raises FetchError when the project identity is missing or the project
    request fails; a missing README only downgrades the item to
